...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    function instantValidation(field) {
      // rules when field and button should be enable/disable
    ...
    addEvent(document, "input", function(e, target) {
      // real-time on input reaction of enable/disable field
    ...
    setInterval(() => {
      let switch1 = (<HTMLInputElement>document.getElementById("switch1"))
        .checked;
      let switch2 = (<HTMLInputElement>document.getElementById("switch2"))
        .checked;
      let switch3 = (<HTMLInputElement>document.getElementById("switch3"))
        .checked;
        ...
        case 0:
          if (switch1 == true) {
            (document.querySelector("#info") as HTMLElement).style.display =
              "block";
            (document.querySelector("#warning") as HTMLElement).style.display =
              "none";
            (document.querySelector("#danger") as HTMLElement).style.display =
              "none";
            this.date = new Date();
            break;
          }
  ...
  onItemClick(category: string, index: number) {
    ...
    (document.getElementById(
      "txt"
    ) as HTMLElement).innerHTML = `${category} - ${this.listItems[index]}`;
  }
